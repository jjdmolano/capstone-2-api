...
router.put('/:id/categories', (req, res) => {
	...
	UserController.addCategory(arg).then(result => res.send(result))
})
...
router.delete('/:id/:categoryId', (req, res) => {
	...
	UserController.deleteCategory(arg).then(result => res.send(result))
})
...
router.put('/:id/transactions', (req, res) => {
	...
	UserController.addTransaction(arg).then(result => res.send(result))
})
...
router.delete('/:id/tr/:transactionId', (req, res) => {
	...
	UserController.deleteTransaction(arg).then(result => res.send(result))
})
...
router.put('/:id/tr/:transactionId', (req, res) => {
	...
	UserController.updateTransaction(arg).then(result => res.send(result))
})
